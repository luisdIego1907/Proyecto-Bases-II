...
export default function ClientForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log(isEdit ? "EDITAR" : "CREAR", form);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-6">
      <form
        ...
        className="w-full max-w-3xl bg-white rounded-3xl shadow-lg overflow-hidden"
      >
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            ...
            <input
              ...
              className="mt-2 w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-cyan-200 focus:outline-none"
            />
          </div>
        ...
        <div className="px-8 py-6 bg-slate-50 flex justify-end gap-3">
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-medium"
          >
            Guardar
          </button>
        </div>
